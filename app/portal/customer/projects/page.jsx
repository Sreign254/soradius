...
const Projects = () => {
  ...
  const fetchProjects = async () => {
    setLoading(true)
    try {
      const res = await fetch(`${base_url}projects/my-projects`, {
        method: "GET",
        headers: {
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Projects you created or are assigned to</p>
        </div>
        {/* <Button onClick={() => router.push("/portal/customer/projects/create")}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredProjects.map((project) => (
            <ProjectCard
              key={project._id}
              project={project}
              onView={(id) => router.push(`/portal/customer/projects/view/${id}`)}
              onEdit={(id) => router.push(`/portal/customer/projects/edit/${id}`)}
